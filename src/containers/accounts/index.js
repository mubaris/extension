...
import { Button, Tabs, notification, Icon, Card, Popover } from 'antd';
    ...
    return (
      <div className="accounts__button">
        ...
        <Popover
          ...
          content={<AccountsDisplay closeSide={this.handleVisibleChange} isLoggedIn={this.isLoggedIn()} clickSignOut={this.signOut} />}
